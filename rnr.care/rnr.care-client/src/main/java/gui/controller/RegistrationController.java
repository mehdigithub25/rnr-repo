...
public class RegistrationController {
	...
	ObservableList<String> options = FXCollections.observableArrayList("member","vet","trainer","association agent","insurance agent");
...
//}
  ...
  public void RegisterAction(ActionEvent ae) throws SQLException, IOException, NamingException{
        ...
        Member member=new Member(firstName.getText(), lastName.getText(), userName.getText() ,password.getText() , email.getText(),address.getText() , phone) ;
